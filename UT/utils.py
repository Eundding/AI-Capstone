...
from models.maze_ut_new import MazeUTModelNew
from models.maze_ut_final import MazeUTModelF
...
def get_model(model, width, depth):
    ...
    elif model=="maze_ut_final":
        return MazeUTModelF(input_channels=3, hidden_dim=128, max_steps=44, nhead=4, height=32, width=32,out_channels=2)
    elif model == "maze_ut_new":
        return MazeUTModelNew(input_channels=3, hidden_dim=128, max_steps=4, nhead=4, height=32, width=32)
    else:
